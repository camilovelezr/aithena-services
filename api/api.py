...
from aithena_services.llms import Message, Ollama, OpenAI  # type: ignore
...
async def completion_str(model: str, messages: list[dict], stream: bool = True):
    """Generate a chat completion from a simple string."""
